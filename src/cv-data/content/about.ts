...
export const about: AboutInfo = {
  ...
  paragraphs: [
    ls(
      'بنده برنامه‌نویسی را با Vue شروع کردم و پس از تسلط به Nuxt، شروع به یادگیری React کردم و گذاری به دنیای بک‌اند با زبان‌های JS و Go  داشته‌ام. از این رو توانایی قابل توجهی در ارتباط‌گیری با تیم‌های توسعه و ساخت حرفه‌ای محصول دارم.',
    ...
    ls(
      'بنده ۲۹ سال سن دارم و دارای پایان خدمت هستم.',
